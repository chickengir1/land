...
class CircleObject {
  ...
  renderDescriptionText() {
    ...
    let headFontSize = window.innerWidth <= 768 ? "1.2vh" : "1.4vh";
    let textFontSize = window.innerWidth <= 768 ? "1.6vh" : "1.8vh";
